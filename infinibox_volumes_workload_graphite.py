'''
 Examples:
 	Overall Performance Statistics:
 		python infinibox_volumes_workload_graphite.py
        -u "http://<infinimetrics_fqdn>/api/rest/"
        -F <host fqdn>
        -C "systems/<serial#>/monitored_entities"
...
# Associate volume with entitiy id
for vol in global_vars.outcome[0]:
    vol_names.append(vol["name"])
    for entity_id in global_vars.outcome[1]:
        if entity_id["group"] == "Volumes":
...
while i < len(global_vars.outcome):
	...
	messages.append([["{}.{}.{}.{}.{} {} {}".format(graphite_prefix, servername, "Volume", vol_names[i], "read_iops", read_iops, timestamp)],
	 ["{}.{}.{}.{}.{} {} {}".format(graphite_prefix, servername, "Volume", vol_names[i], "read_bytes", read_bytes, timestamp)],
	 ["{}.{}.{}.{}.{} {} {}".format(graphite_prefix, servername, "Volume", vol_names[i], "read_latency", read_latency, timestamp)],
	 ["{}.{}.{}.{}.{} {} {}".format(graphite_prefix, servername, "Volume", vol_names[i], "write_iops", write_iops, timestamp)],
	 ["{}.{}.{}.{}.{} {} {}".format(graphite_prefix, servername, "Volume", vol_names[i], "write_bytes", write_bytes, timestamp)],
	 ["{}.{}.{}.{}.{} {} {}".format(graphite_prefix, servername, "Volume", vol_names[i], "write_latency", write_latency, timestamp)]])
	i += 1
